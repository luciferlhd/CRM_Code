...
{
    [DbContext(typeof(CRM_CodeDbContext))]
    [Migration("20220702151327_Created_Reader_Entity")]
    partial class Created_Reader_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CRM_Code.Authors.Author", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("CRM_Code.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CRM_Code.Readers.Reader", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppReaders", (string)null);
                });

            modelBuilder.Entity("CRM_Code.Readers.ReaderBook", b =>
                {
                    ...
                    b.ToTable("AppReaderBook", (string)null);
                });
            ...
            modelBuilder.Entity("CRM_Code.Books.Book", b =>
                {
                    b.HasOne("CRM_Code.Authors.Author", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CRM_Code.Readers.ReaderBook", b =>
                {
                    b.HasOne("CRM_Code.Books.Book", null)
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CRM_Code.Readers.Reader", null)
                        .WithMany("Books")
